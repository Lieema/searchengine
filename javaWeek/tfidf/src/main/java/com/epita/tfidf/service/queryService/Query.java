...
import com.epita.tfidf.util.Pair;
...
public abstract class Query extends Logger {
    ...
    public List<Document> processQuery(@NotNull final String request) {
        ...
        final com.epita.tfidf.model.Query query = new com.epita.tfidf.model.Query();
    ...
    @Pure
    protected List<Document> processQuery(@NotNull final com.epita.tfidf.model.Query query) {
